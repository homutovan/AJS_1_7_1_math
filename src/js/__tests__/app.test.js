import characterFabric from '../app';
...
test.each(Object.entries(params))(('check params up 1LVL: type=%s, expects: %s *1.2'), (type, param) => {
  const character = characterFabric('Merlin', type, Character);
  character.levelUp();
